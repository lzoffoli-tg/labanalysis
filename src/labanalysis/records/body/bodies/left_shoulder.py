...
__all__ = ["LeftShoulder"]


class LeftShoulder(Joint):
    """LeftShoulder Joint."""
    ...
    def _elbow_center(self):
        """return the left elbow in the local joint reference frame"""
    ...
    def internalexternalrotation(self):
        ...
        vec = self["elbow_medial"] - self["elbow_lateral"]  # type: ignore
        vec = self.apply(vec)
