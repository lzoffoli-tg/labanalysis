...
class TestTrainingLogger:
    ...
    def test_init(self):
        ...
        logger = TrainingLogger(early_stopping_patience=100)
    ...
    def test_update_early_stopping_improved(self):
        ...
        logger = TrainingLogger(early_stopping_patience=10)
...
class TestPinballLoss:
    ...
    def test_forward_median(self):
        ...
        loss_fn = PinballLoss(quantile=0.5)
...
class TestQuantilicRangeLoss:
    ...
    def test_init(self):
        """Test initialization."""
        loss = QuantilicRangeLoss(confidence=0.99)
    ...
    def test_init_invalid_confidence(self):
        ...
        with pytest.raises(ValueError, match="must be a float in"):
            QuantilicRangeLoss(confidence=1.5)

    def test_forward(self):
        """Test forward pass."""
        loss_fn = QuantilicRangeLoss(confidence=0.95)
...
class TestComboLoss:
    ...
    def test_init(self):
        """Test initialization."""
        loss1 = PinballLoss(0.5)
        loss2 = MAEMetric()
        combo = ComboLoss(loss1, loss2)
...
class TestUncertaintyWeighting:
    ...
    def test_init(self):
        """Test initialization."""
        uw = UncertaintyWeighting(["output1", "output2"])
    ...
    def test_gradients(self):
        ...
        uw = UncertaintyWeighting(["output1"])
...
class TestTorchTrainer:
    ...
    def test_process_batch(self, simple_model, simple_tensors):
        ...
        x, y = simple_tensors
        trainer = TorchTrainer(loss=nn.MSELoss())
    ...
    def test_fit_combo_loss(self, simple_model, simple_tensors):
        ...
        combo_loss = ComboLoss(
            PinballLoss(0.5), QuantilicRangeLoss(0.99)
        )
...
class TestIntegration:
    ...
    def test_full_training_pipeline(self):
        ...
        trainer = TorchTrainer(
            loss=ComboLoss(PinballLoss(0.5), nn.MSELoss()),
            metrics=[MAEMetric()],
...
class TestTorchTrainerV2Features:
    ...
    def test_compute_optimal_num_workers_small_dataset(self):
        ...
        num_workers = TorchTrainer._compute_optimal_num_workers(500)
    ...
    def test_compute_optimal_num_workers_large_dataset(self):
        ...
        num_workers = TorchTrainer._compute_optimal_num_workers(5000)
