...
class TestUprightPosture:
    ...
    def test_module_imports(self):
        ...
        from labanalysis.exercises.posture.upright_posture import UprightPosture
    ...
    def test_upright_posture_docstring_exists(self):
        ...
        assert (
            "balance" in UprightPosture.__doc__.lower()
            or "posture" in UprightPosture.__doc__.lower()
        )
