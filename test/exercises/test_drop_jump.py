...
class TestDropJumpLocIloc:
    ...
    def dropjump(self):
        ...
        from labanalysis.exercises.drop_jump import DropJump
        from test.protocols.jumptests.synthetic_jump_generators import generate_drop_jump_force_platform

        bodymass = 75.0
        box_height = 40.0
        fp_left = generate_drop_jump_force_platform(bodymass_kg=bodymass/2, drop_height_cm=box_height, jump_height_m=0.25, side='left', fsamp=1000.0)
        fp_right = generate_drop_jump_force_platform(bodymass_kg=bodymass/2, drop_height_cm=box_height, jump_height_m=0.25, side='right', fsamp=1000.0)
