...
class TestSingleJumpLocIloc:
    ...
    def singlejump(self):
        ...
        from labanalysis.exercises.single_jump import SingleJump
        from test.protocols.jumptests.synthetic_jump_generators import generate_squat_jump_force_platform

        bodymass = 75.0
        fp_left = generate_squat_jump_force_platform(bodymass_kg=bodymass/2, jump_height_m=0.30, side='left', fsamp=1000.0)
        fp_right = generate_squat_jump_force_platform(bodymass_kg=bodymass/2, jump_height_m=0.30, side='right', fsamp=1000.0)
