...
class TestChangeOfDirectionExercise:
    ...
    def test_module_imports(self):
        ...
        from labanalysis.exercises.agility.change_of_direction import (
    ...
    def test_change_of_direction_docstring_exists(self):
        ...
        assert (
            "agility" in ChangeOfDirectionExercise.__doc__.lower()
            or "direction" in ChangeOfDirectionExercise.__doc__.lower()
        )
