...
__all__ = ["test_regression_models"]
...
def test_base_regression_fit_predict_copy(sample_data):
    X, Y = sample_data
...
def test_polynomial_regression_fit_predict_copy(sample_data):
    X, Y = sample_data
...
def test_power_regression_fit_predict_copy(sample_data):
    X, Y = sample_data
...
def test_exponential_regression_fit_predict_copy(sample_data):
    X, Y = sample_data
...
def test_multisegment_regression_fit_predict_copy(sample_data):
    X, Y = sample_data
