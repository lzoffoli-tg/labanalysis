...
- [Running Test Protocol](../../user-guide/test-protocols/locomotion-tests.md) - Running analysis guide
- [Walking Test Protocol](../../user-guide/test-protocols/locomotion-tests.md) - Walking analysis guide
