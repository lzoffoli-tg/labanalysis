...
- **[API Reference: MetabolicRecord](../../api/records/records.md#metabolicrecord)** - Metabolic data class
- **[API Reference: SubmaximalVO2MaxTest](../../api/protocols/vo2max.md)** - Test protocol
