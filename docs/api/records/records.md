...
- **[User Guide: Data Loading](../../guides/data-loading/overview.md)** - Loading records
- **[User Guide: Force Platforms](../../guides/biomechanics/force-platforms.md)** - Force platform analysis
